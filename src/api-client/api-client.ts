...
const global: ContentSet = {
	title: [{ content: { text: 'Sangawa Project' } }],
	page: [
		{
			content: {
				page: 'home',
	...
	register: [{ content: { text: 'REGISTER', href: '/registration' } }],
	twitter: [{ content: { text: 'Twitter', href: 'https://twitter.com/sangawaproject' } }],
	facebook: [{ content: { text: 'Facebook', href: 'https://facebook.com/sangawaproject' } }],
};
